...
import { BarChart3, TrendingUp, DollarSign, Clock, Zap, Target, Shield, Users } from 'lucide-react'
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-orange-600 via-orange-700 to-orange-800 rounded-3xl p-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-orange-100 text-lg mb-6 max-w-2xl">
            Maximize your returns through various DeFi earning strategies. Stake, farm, and earn dividends from your RWA holdings.
          </p>
      ...
      <Card className="border-0 shadow-md">
        <CardHeader>
          <CardTitle className="text-2xl">Why Choose Our Earning Platform?</CardTitle>
          <CardDescription>Built with security, flexibility, and community in mind</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="border-0 shadow-md bg-gradient-to-br from-slate-50 to-slate-100">
        <CardHeader>
          ...
          <CardDescription>Our planned rollout of earning features</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            <div className="flex items-center gap-4 p-4 bg-white rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">Simple token staking with fixed APY rewards</p>
              </div>
              <Badge variant="secondary" className="bg-emerald-100 text-emerald-700">In Progress</Badge>
            </div>
            <div className="flex items-center gap-4 p-4 bg-white rounded-xl">
              <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
              <div className="flex-1">
                <h4 className="font-semibold">Q2 2024 - Yield Farming</h4>
                <p className="text-sm text-gray-600">Liquidity provision and farming rewards</p>
              </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-white rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">Real-world asset dividend distribution</p>
              </div>
              <Badge variant="secondary">Planned</Badge>
            </div>
            <div className="flex items-center gap-4 p-4 bg-white rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">Auto-compounding and strategy optimization</p>
              </div>
              <Badge variant="secondary">Planned</Badge>
            </div>
          </div>
      ...
      <Card className="border-0 shadow-md bg-gradient-to-r from-emerald-600 to-emerald-700 text-white">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-emerald-100 mb-6 max-w-md mx-auto">
            Be the first to know when our earning features go live. Get exclusive early access and bonus rewards.
          </p>
